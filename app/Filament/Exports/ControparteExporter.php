...
class ControparteExporter extends Exporter
{
    ...
    {
        $body = 'Your controparte export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
