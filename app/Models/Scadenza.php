...
class Scadenza extends Evento
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($scadenza) {

            // set data_ora from data and ora
            if (isset($model->data) && isset($model->ora)) {

                $model->data_ora = $model->data . ' ' . $model->ora;
            }
